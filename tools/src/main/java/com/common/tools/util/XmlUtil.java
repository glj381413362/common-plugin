...
public class XmlUtil {
	 ...
	 */
	public static String beanToXml(Object bean, boolean ignoreNull, PropertyNamingStrategy propertyNamingStrategy) {
	...
	public static void main(String[] args) {
		...
		Msg msg = new Msg();
		msg.setMsgTemplate("aaaa");
		String s = beanToXml(msg, false, PropertyNamingStrategy.LOWER_CAMEL_CASE);
		s = beanToXml(msg, false, PropertyNamingStrategy.KEBAB_CASE);
		s = beanToXml(msg, false, PropertyNamingStrategy.LOWER_CASE);
		s = beanToXml(msg, false, PropertyNamingStrategy.LOWER_DOT_CASE);
		s = beanToXml(msg, false, PropertyNamingStrategy.SNAKE_CASE);
		s = beanToXml(msg, false, PropertyNamingStrategy.UPPER_CAMEL_CASE);
